...
A background agent that analyzes observations from Augment Agent sessions to detect patterns and create instincts.
...
- Project: `~/.augment/homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.augment/homunculus/observations.jsonl`
...
- Project: `~/.augment/homunculus/projects/<project-hash>/instincts/personal/`
- Global: `~/.augment/homunculus/instincts/personal/` (for universal patterns)
