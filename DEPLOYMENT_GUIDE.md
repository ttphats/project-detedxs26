...
**Backend URL:** `https://api.tedxfptuniversityhcmc.com`

Cloudflare Tunnel đã được setup và tự động cung cấp HTTPS cho backend!
...
## 📋 Alternative Solutions (If not using Cloudflare Tunnel)
