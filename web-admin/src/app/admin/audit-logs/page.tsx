...
export default function AuditLogsPage() {
  ...
  const columns: ColumnsType<AuditLog> = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          ...
          {record.userRole && (
            <Tag color={roleColors[record.userRole] || 'default'} className='mt-1'>
              {record.userRole}
            </Tag>
          )}
        </div>
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          <Tag color={entityColors[record.entity] || 'default'}>{record.entity}</Tag>
          {record.entityId && (
    ...
    <AdminLayout>
      <div className='space-y-6'>
        ...
        <Row gutter={16}>
          <Col span={6}>
            <Card>
              <Statistic title='Tổng log' value={pagination.total} prefix={<HistoryOutlined />} />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
            ...
            <div className='space-y-4'>
              <Descriptions bordered column={2} size='small'>
                ...
                <Descriptions.Item label='Vai trò'>
                  <Tag color={roleColors[detailModal.userRole || ''] || 'default'}>
                ...
                <Descriptions.Item label='IP Address' span={2}>
                  <code className='text-xs'>{detailModal.ipAddress || '-'}</code>
                </Descriptions.Item>
              </Descriptions>
                ...
                <div>
                  ...
                  <div className='bg-purple-50 p-3 rounded space-y-1'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span className='font-medium'>{detailModal.metadata.device.os}</span>
                    </div>
                    <div className='flex items-center gap-2'>
                      <span className='text-gray-500 text-sm'>Browser:</span>
                      <span className='font-medium'>{detailModal.metadata.device.browser}</span>
                    </div>
                    <div className='flex items-center gap-2'>
                      ...
                      <Tag
                        color={
                          detailModal.metadata.device.deviceType === 'Mobile'
                            ? 'blue'
                            : detailModal.metadata.device.deviceType === 'Tablet'
                              ? 'purple'
                              : 'green'
                        }
                      >
              ...
              {detailModal.userAgent && (
                <div>
                  ...
                  <p className='text-xs text-gray-500 break-all'>{detailModal.userAgent}</p>
                </div>
              )}
            </div>
          )}
