  ...
  return (
    <div className="min-h-screen bg-black pt-24 pb-12">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`fixed top-20 left-0 right-0 z-40 px-4 sm:static sm:mb-6 ${isExpired ? "animate-pulse" : ""}`}
        >
          <div
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2 sm:gap-3">
                {isExpired ? (
                  ...
                  <Clock
                    className={`w-5 h-5 sm:w-6 sm:h-6 ${timeLeft <= 60 ? "text-yellow-400" : "text-red-400"}`}
                  />
                )}
                <div>
                  <p
                      ...
                      <div className="w-48 h-48 bg-white rounded-lg flex items-center justify-center relative overflow-hidden">
                        <div className="absolute inset-0 grid grid-cols-10 gap-0.5 p-3">
                          {Array.from({ length: 100 }).map((_, i) => (
                            <div
                              key={i}
                              className={`aspect-square rounded-sm ${Math.random() > 0.5 ? "bg-gray-900" : "bg-white"}`}
                            />
                          ))}
                        </div>
            ...
            <div className="sticky top-24">
              ...
              >
                ...
                <p className="text-xs text-gray-500 text-center mt-4">
                  Sau khi chuyển khoản, vui lòng nhấn &quot;Đã thanh toán&quot;
                  để xác nhận
                </p>
              </div>
            </div>
