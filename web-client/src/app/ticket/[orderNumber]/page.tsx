...
const MESSAGES: Record<string, string> = {
  ...
  "status.pending.desc":
    "Please complete the bank transfer to reserve your tickets.",
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-amber-100/90 leading-relaxed mb-3">
                <strong>Save / copy this link</strong> to reopen your ticket
                anytime. The access token <strong>does not expire</strong> —
                keep it private.
              </p>
              <button
                type="button"
