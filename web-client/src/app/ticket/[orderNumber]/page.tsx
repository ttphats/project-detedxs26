...
export default function TicketPage({params}: {params: Promise<{orderNumber: string}>}) {
  ...
  const handleDownload = async () => {
    setDownloading(true)
    try {
      // Add print-specific styles with color preservation
      ...
      setTimeout(() => {
        const styleElement = document.getElementById('ticket-print-styles')
        if (styleElement) {
          styleElement.remove()
        }
      }, 1000)
                ...
                <div className='grid grid-cols-2 gap-4'>
                  ...
                  <div className='flex items-start gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-white font-medium'>
                        {ticket.event ? formatTime(ticket.event.startTime) : '-'}
                      </p>
                    </div>
                  </div>
            ...
            <div className='p-6 pt-2'>
              ...
              {ticket.canDownload && ticket.qrCodeUrl && (
                <div className='mb-6'>
                  ...
                  <p className='text-xs text-gray-500 mt-2'>Quét mã này tại quầy check-in</p>
                </div>
              )}
